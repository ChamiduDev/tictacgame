...
export default function GameBoard({
  ...
  return (
    <div className="w-full max-w-[min(90vw,460px)] mx-auto p-3.5 sm:p-4.5 bg-[#0a0c1e]/90 border border-white/15 rounded-2xl backdrop-blur-2xl shadow-[0_20px_50px_-8px_rgba(0,0,0,0.85)] relative">
                ...
                <AnimatePresence>
                  {cell && (
                    <motion.span
                      ...
                      className={`${SYMBOL_COLORS[cell]} ${SYMBOL_SHADOWS[cell]} ${cellStyle.fontSize} ${isWinning ? "animate-bounce" : ""}`}
                    >
                      {cell}
                    </motion.span>
                  )}
